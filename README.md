...
- **Miljö:** Produktion
- **Källkod:** [azure-game-excersize](https://github.com/danirank/azure-game-excersize)

## Ansvarsfördelning

| Gruppmedlem | Ansvar |
| --- | --- |
| Pontap | Stabiliserade och färdigställde spelet. |
| Kevin | Arbetade som game producer och samordnade utvecklingen. |
| Daniel | Driftsatte applikationen på sitt Azure-konto med stöd från Kevin och Pontap. |
